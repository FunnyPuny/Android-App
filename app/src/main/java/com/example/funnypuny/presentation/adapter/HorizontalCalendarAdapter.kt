...
class HorizontalCalendarAdapter(private val context: Context,
                                ...
                                private val changeMonth: Calendar?): RecyclerView.Adapter<HorizontalCalendarAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, position: Int): ViewHolder {
        val inflater = LayoutInflater.from(context).inflate(R.layout.item_day,parent,false)
